#!/usr/bin/env python3
"""FoldLock v0.8 UNI1 — SOTA zip-class compression engine for UTF-8 text.
...
LIMITATION = (
    "THIS IS: SOTA compression software and a compression engine — zip-class "
    "for UTF-8 text; adaptive UNI1 fold (classify → bakeoff → passthrough); "
    ...
    "THIS IS NOT: the ZIP container format (PKZIP/.zip); a zlib/gzip/DEFLATE/"
    "zstd/lzma wrapper; a claim every file shrinks or that FoldLock beats zstd "
    "on all files; a universal compressor; translation of all inputs to Latin; "
    "encryption; UL; EmployeeLock; TemporalLock; GodLock; a published industry "
    "bake-off. "
